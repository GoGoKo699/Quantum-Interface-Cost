...
Updated: 2026-09-24. Stage: the [Jordan-block converse](audits/JORDAN_BLOCK_CONVERSE.md) proves Gamma(3,3)<=4+sqrt(2) for every three-input seed of rank at most three, with full trace norms, arbitrary spectra, and no antiunitary assumption. It also closes four of the ten nonscalar ququart signature patterns. Any strict improvement at (n,q)=(3,2) requires a nonflat rank-four seed and a pair with two noncommuting Jordan blocks; six signature patterns remain. An exact counterexample rules out the immediate extension of the intermediate projector bound, without violating the interface conjecture. Unrestricted equal-accuracy optimality and publication originality remain open. The prior nonlinear-CHSH subsumption remains in force.
Latest research base: `012bafa1895a66e22eac676ba1702a2bde531881`, the merge of PR #34.
