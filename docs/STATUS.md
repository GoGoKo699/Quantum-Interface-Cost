...
Updated: 2026-09-24. Stage: the [joint-spectrum continuation](audits/JOINT_SPECTRUM_NORMAL_FORM.md) gives a complete seven-parameter representation of two sharp anticommuting ququart pairs, using established Cartan decomposition. An eight-dimensional singular-value problem retains their full spectrum and actual top memory marginal. Exact full-rank synthetic data show that the available separate spectral, SLD, six-Pauli and fixed-spectrum score constraints do not imply the preceding rank-one certificate. No realizable failure of that strategy is supplied. The sharp-pair joint constraint, all three complete reflection signatures, unrestricted equal-accuracy optimality and publication originality remain unresolved. The preceding readout-elimination and local-stability theorems remain valid; the prior nonlinear-CHSH subsumption remains in force.
Latest research base: `0f10c57dec2f54a4a8d7e9293f0a1a19bc99c1f1`, the merge of PR #41.
