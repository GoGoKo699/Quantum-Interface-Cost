...
Updated: 2026-09-24. Stage: the [unified antiunitary theorem](audits/ANTIUNITARY_READOUT_BOUND.md) gives the sharp classwide score 2sqrt(6) whenever one antiunitary negates all six ququart binary readouts. Its square may be nonscalar, and the readouts may be general Hermitian contractions. The +I case reduces to two commuting qubit algebras; the -I case retains the preceding sharp spin-flip purity theorem. General balanced readouts need not admit any common antiunitary. Unrestricted equal-accuracy optimality and publication originality remain open. The prior nonlinear-CHSH subsumption remains in force.
Latest research base: `0730608b9daa9ba09a27843d57b47134a5852fd4`, the merge of PR #33.
